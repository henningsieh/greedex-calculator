...
export type AnimatedGroupProps = {
  ...
  // When true, animate children when the group scrolls into view
  triggerOnView?: boolean;
  // Options forwarded to `viewport` prop on Motion component
  ...
  return (
    <MotionComponent
      ...
      {...(triggerOnView
        ? {
            whileInView: "visible",
            viewport: viewport ?? { once: true, amount: 0.35 },
          }
        : { animate: "visible" })}
