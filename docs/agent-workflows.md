...
For any Next.js task, use the `.next-docs` index embedded in `AGENTS.md` and read the matching local pages before editing. For data fetching and SSR, start with:

- `.next-docs/01-app/01-getting-started/05-server-and-client-components.mdx`
- `.next-docs/01-app/01-getting-started/06-fetching-data.mdx`
- `.next-docs/01-app/02-guides/prefetching.mdx`

Project architecture, oRPC, and TanStack Query instructions still apply.
